          ...
          <div className="flex flex-col lg:flex-row gap-12">
            ...
            <div className="w-full lg:w-1/3">
              <div className="bg-bakery-cream p-6 rounded-lg shadow-sm mb-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center">
                    <Phone className="h-5 w-5 text-bakery-pink-dark mr-3" />
                    <p className="text-gray-700">916-337-8880</p>
                  </div>
                  <div className="flex items-center">
                    <Mail className="h-5 w-5 text-bakery-pink-dark mr-3" />
                    <p className="text-gray-700">
                      roseandsugarcookies@gmail.com
                    </p>
                  </div>
                  <div className="flex items-center">
                    <Instagram className="h-5 w-5 text-bakery-pink-dark mr-3" />
                    <a
                      href="https://www.instagram.com/roseandsugarcookies/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-gray-700 hover:text-bakery-pink-dark transition-colors"
                    >
                      @roseandsugarcookies
                    </a>
                  </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h2 className="font-bebas text-2xl mb-4">Business Hours</h2>
